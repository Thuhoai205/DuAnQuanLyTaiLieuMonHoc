 ...
 $notificationCount = ActivityLog::where('is_read', false)->count();
     ...
     <div id="adminNotificationDropdown"
         ...
         <div
             ...
             <div>
                 ...
                 <p class="text-xs font-semibold text-slate-500 mt-1">
                     {{ number_format($notificationCount) }} thông báo chưa đọc
                 </p>
             </div>
         ...
         <div class="max-h-[360px] overflow-y-auto">
             ...
             <div class="px-5 py-10 text-center">
                 ...
                 <p class="text-sm font-semibold text-slate-500 mt-2">
                     Các thông báo đăng nhập và đăng xuất sẽ hiển thị tại đây.
                 </p>
             </div>
             @endforelse
         </div>
         ...
         <div class="px-5 py-4 bg-slate-50 border-t border-cyan-100 flex items-center justify-between gap-3">
             ...
             <form action="{{ route('admin.logs.readAll') }}" method="POST">
                 ...
                 <button type="submit"
                     class="px-4 py-2 rounded-xl bg-cyan-600 text-white text-sm font-black hover:bg-cyan-700 transition">
                     Đánh dấu đã đọc
                 </button>
             </form>
             @endif
